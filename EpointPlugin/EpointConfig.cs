...
namespace EpointPlugin
{
    ...
    public class ShopItem
    {
        ...
        [JsonProperty("物品数量")] public int Stack { get; set; } // 购买一次给多少个（如药水给5个）
        ...
        public static EpointConfig Read(string filePath)
        {
            ...
            if (!File.Exists(filePath))
            {
                ...
                string defaultJson = """
                {
                  ...
                  "商品列表": [
                    { "序号": 1, "商品名称": "强效治疗药水", "原版物品ID": 499, "积分价格": 20, "物品数量": 5, "是否限购": false },
                    { "序号": 2, "商品名称": "生命水晶", "原版物品ID": 29, "积分价格": 1000, "物品数量": 1, "是否限购": false },
                    { "序号": 3, "商品名称": "史莱姆法杖", "原版物品ID": 1309, "积分价格": 5000, "物品数量": 1, "是否限购": true },
                    { "序号": 4, "商品名称": "女巫扫帚", "原版物品ID": 4778, "积分价格": 10000, "物品数量": 1, "是否限购": true },
                    { "序号": 5, "商品名称": "混沌传送杖", "原版物品ID": 1326, "积分价格": 20000, "物品数量": 1, "是否限购": true }
                  ]
                }
                """;
                // 将上面写好的模板写进硬盘
