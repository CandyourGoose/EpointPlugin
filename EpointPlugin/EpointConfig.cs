            ...
            if (!File.Exists(filePath))
            {
                ...
                string defaultJson = """
                {
                  ...
                  "道具列表": [
                    ...
                    { "序号": 7, "商品名称": "史莱姆法杖", "原版物品ID": 1309, "积分价格": 6000, "物品数量": 1, "是否限购": true },
                    { "序号": 8, "商品名称": "捣蛋猫", "原版物品ID": 5663, "积分价格": 6000, "物品数量": 1, "是否限购": true },
                    { "序号": 9, "商品名称": "火绒狐", "原版物品ID": 5664, "积分价格": 8000, "物品数量": 1, "是否限购": true },
                    { "序号": 10, "商品名称": "骨镐", "原版物品ID": 1320, "积分价格": 5000, "物品数量": 1, "是否限购": true },
                    { "序号": 11, "商品名称": "混沌传送杖", "原版物品ID": 1326, "积分价格": 10000, "物品数量": 1, "是否限购": true },
                    { "序号": 12, "商品名称": "女巫扫帚", "原版物品ID": 4444, "积分价格": 12000, "物品数量": 1, "是否限购": true },
                    { "序号": 13, "商品名称": "棱彩染料", "原版物品ID": 4778, "积分价格": 10000, "物品数量": 1, "是否限购": false }
                  ]
                }
                """;
                // 将上面写好的模板写进硬盘
